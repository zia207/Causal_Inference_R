[![](Image/open_colab.png){fig-align="left" width="150"}](https://github.com/zia207/Causal_Inference_R/blob/main/Notebook/02_08_05_05_03_05_deep_causal_ml_causal_structural_learning_regularization_castle_r.ipynb)

![](Image/05-03-deep-CausalML-structural-learning.png)

# 5.3.5 CASTL: CAusal STructure LEarning Regularization {.unnumbered}
...
![](Image/CASTLE_arcitecture.png){width="633"}
...
#| warning: false
# Use local RCausalML when rendering from package root, tutorials/, or sibling repo
