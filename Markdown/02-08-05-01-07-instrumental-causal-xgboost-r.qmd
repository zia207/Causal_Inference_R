[![](Image/open_colab.png){fig-align="left" width="150"}](https://github.com/zia207/Causal_Inference_R/blob/main/Notebook/02_08_05_01_07_instrumental_causal_xgboost_r.ipynb)
![](Image/banner_Causal_Inference_Tree_Based.png){fig-align="left" width="1400"}

# 5.1.7 Instrumental Causal XGBoost (Boosted IV Forest) {.unnumbered}
