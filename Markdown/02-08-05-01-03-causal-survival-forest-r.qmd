[![](Image/open_colab.png){fig-align="left" width="150"}](https://github.com/zia207/Causal_Inference_R/blob/main/Notebook/02_08_05_01_03_causal_survival_forest_r.ipynb)

![](Image/banner_Causal_Inference_Tree_Based.png){fig-align="left" width="1400"}

# 5.1.3 Causal Survival Forest (CSF) {.unnumbered}
...
![](Image/cuasal_survival_forest.png){width="576"}
